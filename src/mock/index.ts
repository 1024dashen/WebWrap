...
export const mockTemplates: CardKeyTemplate[] = [
    {
        id: '1',
        name: '默认卡密模板',
        htmlContent: '<html><body><h1>{{cardKey}}</h1></body></html>',
    ...
    },
    {
        ...
        name: '节日卡密模板',
        htmlContent:
            '<html><body><div class="festival"><h1>{{cardKey}}</h1></div></body></html>',
